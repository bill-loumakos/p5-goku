		...
		class Asteroid
		{
			...
			*/
			constructor()
			{
				...
				this.explosionImage = loadImage("game-assets/explosion.png");
				this.load();
			}
		...
		class MissilePack
		{
			...
			constructor()
			{
				this.x = 0;
				this.y = 0;
				this.image = loadImage("game-assets/energyorb.png");
		...
		class SpaceShip
		{
			...
			constructor()
			{
				this.image = loadImage("game-assets/goku.png");
		...
		{	
			...
			*/
			constructor()
			{
				...
				{
					let live = loadImage("game-assets/hearts.png");
					this.lives[i] = live;
				}
			}
		...
		*/
		function preload() 
		{
			background = loadImage("game-assets/space.jpg");		// load the background-image
			asteroidImage = loadImage("game-assets/spaceship.png"); // load once and the pass to Asteroid so that will not load each time an Asteroid is created
			spaceship = new SpaceShip();
			
			missileImage = loadImage("game-assets/kameha.png");
